...
public class Livro {
	...
	public Livro(String titulo,String autor, Categoria categoria, Editora editora ) { 
	...
	public void addListEmprestimos(Emprestimo emprestimo) {
		this.emprestimoItems.add(emprestimo);
	}
